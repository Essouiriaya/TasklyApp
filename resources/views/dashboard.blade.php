                                            ...
                                            <div class="task-card card mb-2 p-2" data-id="{{ $task->id_task }}" draggable="true" ondragstart="drag(event)">
                                                <div class="task-summary d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="actions d-flex">
                                                        ...
                                                        <form action="{{ route('tasks.destroy', $task->id_task) }}" method="POST" onsubmit="return confirm('Please take a moment to review your decision. Are you sure ?')">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        <ul class="list-group">
                            @foreach($allProjects as $proj)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('board.destroy', $proj->id_projet) }}" method="POST" onsubmit="return confirm('Please take a moment to review your decision. Are you sure ?')">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-sm btn-outline-dark">
                                            <i class="bi bi-trash"></i>
